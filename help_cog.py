...
{self.bot.command_prefix}p <url or query> - finds the song on youtube and plays it in your current channel. Will resume playing the current song if it was paused
...
"""
    ...
    async def on_ready(self):
        ...
        await self.bot.change_presence(activity=discord.CustomActivity(name=f"type {self.bot.command_prefix}help to display all the available commands"))
